...
So, formally, we say that a set is countable if we can list them like the natural numbers, i.e. if we can establish a _bijection_ between the set and the natural numbers. As a matter of fact, there exists a bijection from $$
