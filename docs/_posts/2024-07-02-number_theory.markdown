...
* Division Algorithm: Let $$a,b \in \mathbb{Z}$$ with $$b \not = 0$$. Then, there exists unique $$q,r \in \mathbb{Z}$$ such that $$a = bq + r$$, where $$0 \leq r \lt \lvert b \rvert}$$. Note that $$\lvert b \rvert$$ represents the absolute value of $$b$$. 
